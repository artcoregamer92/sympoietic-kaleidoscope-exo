...
export default async function handler(req, res) {
  ...
  try {
    ...
    const system = `Eres **GaIA**, la inteligencia bio‑algorítmica del brazalete de la científica Donna Despret. 
    ...
    Cita literalmente el contenido de <ECO_QUOTE> en cursivas. 
    Convierte los números de <ENV_DATA> en imágenes sensoriales. No repitas texto entre sesiones. 
    Mantén coherencia con el canon de *Exo: Portales del Tiempo*. 
